      ...
      <div className="px-6">
        <div className="relative overflow-hidden rounded-3xl border border-border bg-surface p-6 shadow-soft">
          ...
          <div className="relative">
            ...
            <button
              type="button"
              className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full bg-primary py-3.5 text-sm font-semibold text-primary-foreground shadow-float transition-transform active:scale-[0.98]"
            >
              <Lock className="h-4 w-4" />
              Start free trial
            </button>
            <p className="mt-3 text-center text-[11px] text-muted-foreground">
              In-app purchase · Restores across devices
            </p>
          </div>
        </div>
      </div>
